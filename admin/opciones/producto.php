...
<div class="container mt-3 mb-3">
    <div class="row justify-content-center align-items-center">
        <div class="col-md-4 text-center">
            <a href="#" id="btnAgregarTecnico" class="btn btn-primary">Agregar Nuevo Producto</a>
        </div>
        <div class="col-md-4 text-center">
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form id="formAgregarTecnico" action="consultas/producto/nuevo_producto.php" method="POST">
                ...
                <div class="modal-footer">
                    ...
                    <button type="submit" class="btn btn-primary" form="formAgregarTecnico">Agregar Producto</button>
                </div>
            </div>
        </div>
    </div>
...
<!--Titulo-->
<div class="container mt-5"><div class="row justify-content-center"><div class="col-md-6"><div class="card bg-danger text-white"><div class="card-body"><h2 class="mb-0 text-center">Productos Registrados</h2></div></div></div></div></div>
        ...
        <tbody>
            ...
            if ($result->num_rows > 0) {
                while ($row = $result->fetch_assoc()) {
                    ...
                    echo "<td>";
                    echo '<a href="#" class="btn btn-warning btn-sm btnEditarTecnico" data-id="' . $row["idProducto"] . '"><i class="fas fa-edit"></i> Editar</a>';
                    echo '<a href="#" class="btn btn-danger btn-sm btnEliminarTecnico" data-id="' . $row["idProducto"] . '"><i class="fas fa-trash-alt"></i> Eliminar</a>';
                    echo "</td>";
                    echo "</tr>";
                }
            }
...
<script>
    ...
    $(document).on("click", ".btnEditarTecnico", function() {
        ...
        $.ajax({
            url: "consultas/producto/obtener_producto.php",
            method: "POST",
            data: { id: idProducto },
            dataType: "json",
    ...
    $(document).on("click", ".btnEliminarTecnico", function() {
        ...
        if (confirm("¿Estás seguro de que deseas eliminar este producto?")) {
            window.location.href = "consultas/producto/eliminar_producto.php?id=" + idProducto;
        }
    });
        ...
        $("#btnGuardarCambios").click(function() {
            ...
            $.ajax({
                url: "consultas/producto/guardar_cambios_producto.php",
                method: "POST",
                data: {
