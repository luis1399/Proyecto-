...
if(isset($_POST['idCliente'], $_POST['nombre'], $_POST['direccion'], $_POST['correo'], $_POST['telefono'])) {
    ...
    $sql = "UPDATE cliente SET nombre = '$nombre', direccion = '$direccion', correo = '$correo', telefono = '$telefono' WHERE idCliente = $idCliente";
