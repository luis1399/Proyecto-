...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if (empty($nombre) || empty($direccion) || empty($correo) || empty($telefono)|| empty($rfc)) {
        // Manejar el caso de datos incompletos
        echo "Por favor complete todos los campos.";
    } else {

         $sql = "INSERT INTO proveedor (nombre, rfc, direccion, correo, telefono) VALUES ('$nombre', '$rfc', '$direccion', '$correo', '$telefono')";
